      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            {/* <button
              type="button"
              className="ml-2 rounded-full bg-gray-200 p-1 text-gray-500 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400"
              aria-label="Help with description"
              onClick={() => {
            ...
            >
             ...
             {/* <div className={`text-amber-800 rounded-md text-sm ${showPopup ? 'text-opacity-80' : 'text-opacity-0'} p-2`}>
                  <p>this gives the AI assistant more insight about your matter and so his discussions will remain within context</p>
                </div> */}
            <Textarea
              id="issue-description"
              placeholder="this gives the AI assistant more insight about your matter and so his discussions will remain within context"
              value={description || ''}
